[tssprojectcytv1-4c74] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [tssprojectcytv1-4c74] container is NOT running**.

.. tip::
   You must have your [tssprojectcytv1-4c74] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/SaiyanShrestha/rashpberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env READTHEDOCS=<Enter your readthedocs token>  \-\-env EXTERNALPORT=36017  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME=saiyanshrestha  \-\-env GITPASSWORD=<Enter personal access token>  \-\-env DOCKERUSERNAME=saiyanshrestha  \-\-env DOCKERPASSWORD=<Enter your docker hub password>  \-\-env MQTTUSERNAME=saiyanshrestha  \-\-env MQTTPASSWORD=<Enter your mqtt password>  \-\-env KAFKACLOUDUSERNAME=  \-\-env KAFKACLOUDPASSWORD=<Enter your API secret>  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:9005/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=500&topictype=prediction&append=0&secure=1
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=46135
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=57425
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - saiyanshrestha/tssprojectcytv1-4c74-amd64
...
It can be accessed by entering: http://localhost:50027
...
.. important::
   http://localhost:46135/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=500&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:46135/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:46135/<html file>
...
[tssprojectcytv1-4c74] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/saiyanshrestha/rashpberrypi/tree/main/tml-airflow/dags/tml-solutions/tssprojectcytv1-4c74
...
.. important::
   solution_preprocessing_ai_mqtt_dag-tssprojectcytv1-4c74
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=57425, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=40187, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=37653, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=45865, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=36987, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=41451, HPDEHOST=127.0.1.1, HPDEPORT=46373, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=38431

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-1720-tssprojectcytv1-4c74,solution_preprocessing_ai_mqtt_dag-tssprojectcytv1-4c74, python-preprocess-786-tssprojectcytv1-4c74,solution_preprocessing_ai_mqtt_dag-tssprojectcytv1-4c74, python-ai-7479-tssprojectcytv1-4c74,solution_preprocessing_ai_mqtt_dag-tssprojectcytv1-4c74, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
